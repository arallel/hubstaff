                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-9 mt-5 text-end">
                                            {{-- <button class="btn btn-info" data-toggle="modal" data-target="#newProject">New
                                                Project</button> --}}
                                                <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#newProject">Modal Default</button>                                        </div>
                                    </div>
                                        ...
                                        <tbody>
                                            @foreach ($data as $d)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="dropdown">
                                                            <a class=" dropdown-toggle" href="#" data-bs-toggle="dropdown">Action   </a>
                                                            <div class="dropdown-menu">
                                                                <ul class="link-list-opt">
                                                                    <li><button type="button" class="dropdown-item" data-bs-toggle="modal" data-bs-target="#modalDefault">Edit Project</button></li>
                                                                    <li> <form action="{{ route('project.duplicate',$d->project_id) }}" method="POST">
                                                                        @csrf
                                                                        <button type="submit" class="dropdown-item">Duplicate Project</button>
                                                                    </form></li>
                                                                    <li><form action="{{ route('project.delete', $d->project_id) }}"
                                                                        method="POST">
                                                                        @method('delete')
                                                                        @csrf
                                                                        <button type="submit" class="dropdown-item">Delete Project</button>
                                                                    </form></li>
                                                                </ul>
                                                            </div>
                                                        </div>
