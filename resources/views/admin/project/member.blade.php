            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <ul class="nav nav-pills" id="myTab3" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" id="home-tab3" href="{{ url('members') }}">Members(#)</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="{{ url('invites') }}">Invites(#)</a>
                        </li>
                    </ul>
                    <div class="my-2">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <div class="dropdown-menu">
                                            ...
                                            <a class="dropdown-item" href="#">Disable Tracking</a>
