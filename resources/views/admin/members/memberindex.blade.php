                                    ...
                                    <div class="table-responsive">
                                        <table class="table-striped table" id="sortable-table">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <button class="btn" data-toggle="modal"
                                                            data-target="#editBudget">Edit Budget</button>
                                                    </td>
                                                    ...
                                                    <td><button class="btn btn-secondary dropdown-toggle" type="button"
                                                        ...
                                                        <div class="dropdown-menu">
                                                            <a class="dropdown-item" href="#editProject-{{ $d->project_id }}"  data-toggle="modal"
                                                                >Edit Project</a>
                                                                <a class="dropdown-item" href="#" data-toggle="modal"
                                                                data-target="#editBudget">Edit Budget</a>
                                                ...
                                                <div class="modal fade" tabindex="-1" role="dialog" id="editProject-{{ $d->project_id }}">
                                                            ...
                                                            <form action="{{route('project.store')}}" method="post" enctype="multipart/form-data">
                                                                ...
                                                                <div class="modal-body">
                                                                    <div class="fo rm-group">
                                                                        <label>Name *</label>
                                                                        <input type="text" value="{{ $d->project_name }}" id="project-name" name="project_name" class="form-control"
                                                                            value="">
                                                                    </div>
                                                                    ...
                                                                    <div class="mb-4">
                                                                        ...
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-6">
                                                                                ...
                                                                                <div class=" input-group">
                                                                                    <input type="text" class="form-control" name="notify_at" value="80" disabled>
                                                                                    <div class="input-group-prepend ">
                                                                                        <div class="input-group-text">
                                                                                            %  of Budget
                                                                                        </div>
