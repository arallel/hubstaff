                                                ...
                                                <tr>
                                                    ...
                                                    <td><button class="btn btn-secondary dropdown-toggle" type="button"
                                                        ...
                                                        <div class="dropdown-menu">
                                                            <a class="dropdown-item disabled" href="#" data-toggle="modal" data-target="#editProject">Edit Project</a>
                                                            <a class="dropdown-item disabled" href="#"  data-toggle="modal" data-target="#editBudget">Edit Budget</a>
                                                            <a class="dropdown-item" href="#">Restore Project</a>
                                                            <a class="dropdown-item disabled" href="#">Duplicate Project</a>
