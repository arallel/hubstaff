    ...
    <div id="app">
        <section class="section">
            <div class="container mt-5">
                <div class="">
                    <svg version="1.1" width="200px" height="160px" id="layer" xmlns="http://www.w3.org/2000/svg"
                        ...
                        <path class="st0"
                            d="M233.5,290.1h16.4v72.7h-16.4V332H206v30.9h-16.4v-72.7H206V318h27.5V290.1z M312.7,361
                   ...
                   c-0.3,1.3-0.5,2.6-0.5,4.1v2.7h19.3v13h-19.3v35.6h-15.6v-51.5c0-7.1,2-12.8,6-17C598.3,290.1,604.2,288,612.1,288" />
                        <path class="st1"
                            d="M41.3,372.9l28.5,16.5c1.6,0.9,3.6,0.5,4.8-0.9c3.6-4.3,9-7.1,15.1-7.1c6.1,0,11.5,2.8,15.1,7.1
                   ...
                   l0,0l-4.5,2.6c-7.2,4.1-13.5,9.6-18.4,16.2c-0.5,0.7-1,1.4-1.5,2.1C38.8,369.4,39.4,371.9,41.3,372.9" />
                        <path class="st2"
                            d="M45.9,279c-1.6,0.9-2.3,2.9-1.6,4.6c2,5.3,1.7,11.4-1.4,16.7c-3.1,5.3-8.2,8.6-13.8,9.5
                   ...
                   c-0.1-8.6-2.2-17.2-5.9-24.9c-0.9-1.9-3.4-2.6-5.2-1.6L45.9,279z" />
                        <path class="st3"
                            d="M136.4,300.3c-3.1-5.3-3.4-11.4-1.4-16.7c0.6-1.7,0-3.7-1.6-4.6l-28.7-16.4c-1.9-1.1-4.3-0.4-5.2,1.6
